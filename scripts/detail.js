...
// session storage of forms to get in payment.html-----------------------------------------------------------------------
...
//calculates the value and paste it in value input tag------------------------------------------------------------------
function sum() {
    ...
    // session storage on onblur of toDate id------------------------------------------------------
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    //         `<div class="carousel-item">
                    //         <img class="d-block w-100" src="`+e.images.small.url +`"
                    //           alt="Second slide">
                    //       </div>`;
                    // })
